...
.docker-build:
	...
	sudo docker push $(DOCKER_REPO)$(DOCKER_NAMESPACE)/${DOCKER_PROJECTNAME}_$(SERVICE_NAME):$(DOCKER_TAG)
	sudo docker rmi $(DOCKER_REPO)$(DOCKER_NAMESPACE)/${DOCKER_PROJECTNAME}_$(SERVICE_NAME):$(DOCKER_TAG)
