...
type UploadFileHandlerFunc func(UploadFileParams, *v1.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn UploadFileHandlerFunc) Handle(params UploadFileParams, principal *v1.Principal) middleware.Responder {
	return fn(params, principal)
}

// UploadFileHandler interface for that can handle valid upload file params
type UploadFileHandler interface {
	Handle(UploadFileParams, *v1.Principal) middleware.Responder
}
...
/* UploadFile swagger:route POST /v1/file/upload monitor uploadFile
