...
func NewSportAPI(spec *loads.Document) *SportAPI {
	return &SportAPI{
		...
		MonitorDeleteFileHandler: monitor.DeleteFileHandlerFunc(func(params monitor.DeleteFileParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DeleteFile has not yet been implemented")
		}),
		...
		MonitorDownloadFileHandler: monitor.DownloadFileHandlerFunc(func(params monitor.DownloadFileParams) middleware.Responder {
			return middleware.NotImplemented("operation monitor.DownloadFile has not yet been implemented")
		}),
		...
		MonitorGetClubFileZipHandler: monitor.GetClubFileZipHandlerFunc(func(params monitor.GetClubFileZipParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.GetClubFileZip has not yet been implemented")
		}),
		...
		MonitorUploadFileHandler: monitor.UploadFileHandlerFunc(func(params monitor.UploadFileParams, principal *v1.Principal) middleware.Responder {
			return middleware.NotImplemented("operation monitor.UploadFile has not yet been implemented")
		}),
...
type SportAPI struct {
	...
	// MonitorDeleteFileHandler sets the operation handler for the delete file operation
	MonitorDeleteFileHandler monitor.DeleteFileHandler
	...
	// MonitorDownloadFileHandler sets the operation handler for the download file operation
	MonitorDownloadFileHandler monitor.DownloadFileHandler
	...
	// MonitorGetClubFileZipHandler sets the operation handler for the get club file zip operation
	MonitorGetClubFileZipHandler monitor.GetClubFileZipHandler
	...
	// MonitorUploadFileHandler sets the operation handler for the upload file operation
	MonitorUploadFileHandler monitor.UploadFileHandler
...
func (o *SportAPI) Validate() error {
	...
	if o.MonitorDeleteFileHandler == nil {
		unregistered = append(unregistered, "monitor.DeleteFileHandler")
	}
	...
	if o.MonitorDownloadFileHandler == nil {
		unregistered = append(unregistered, "monitor.DownloadFileHandler")
	}
	...
	if o.MonitorGetClubFileZipHandler == nil {
		unregistered = append(unregistered, "monitor.GetClubFileZipHandler")
	}
	...
	if o.MonitorUploadFileHandler == nil {
		unregistered = append(unregistered, "monitor.UploadFileHandler")
	}
...
func (o *SportAPI) initHandlerCache() {
	...
	o.handlers["DELETE"]["/v1/file/delete/{id}"] = monitor.NewDeleteFile(o.context, o.MonitorDeleteFileHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/v1/file/download"] = monitor.NewDownloadFile(o.context, o.MonitorDownloadFileHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/v1/file/download/zip"] = monitor.NewGetClubFileZip(o.context, o.MonitorGetClubFileZipHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["POST"]["/v1/file/upload"] = monitor.NewUploadFile(o.context, o.MonitorUploadFileHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
