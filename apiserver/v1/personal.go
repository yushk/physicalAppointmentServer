...
func (m *Personal) validateFiles(formats strfmt.Registry) error {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["sport","club"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// PersonalTypeSport captures enum value "sport"
	PersonalTypeSport string = "sport"

	// PersonalTypeClub captures enum value "club"
	PersonalTypeClub string = "club"
)
...
func (m *Personal) contextValidateFiles(ctx context.Context, formats strfmt.Registry) error {
