...
type Database interface {
	...
	// 文件管理接口
	UploadFile(ctx context.Context, filename, path string, file []byte) (string, error)
	DownloadFile(ctx context.Context, id string) (string, []byte, error)
	GetClubFileZip(ctx context.Context, club string) ([]*pb.File, error)
